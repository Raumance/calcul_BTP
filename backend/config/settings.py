"""Configuration Django — production / temps réel."""
...
if not DEBUG and SECRET_KEY in _INSECURE_KEYS:
    raise RuntimeError(
        ...
        "Définissez une clé aléatoire longue dans l'environnement."
    )
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {"NAME": "calcul_btp.validators.ComplexPasswordValidator"},
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "calcul_btp.exceptions.custom_exception_handler",
}
...
# En développement sans Redis : fallback mémoire (single-process).
